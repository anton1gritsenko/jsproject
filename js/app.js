var CBOOK = CBOOK || [
{
	full_name: 'Roma Morgun',
	email: 'romanmorg@gmail.com',
	phone: '+380937402119',
	group: 'work'
},
{
	full_name: 'Igor Bondarenko',
	email: 'bondarenkoigor@gmail.com',
	phone: '+380934956010',
	group: 'Work'
},
{
	full_name: 'Alexey Marmura',
	email: 'alexmarusik@gmail.com',
	phone: '+380957733119',
	group: 'family'
},
{
	full_name: 'Alex Soloshenko',
	email: 'roger1223@gmail.com',
	phone: '+380463733134',
	group: 'work'
},
{
	full_name: 'Dmytriy Komarov',
	email: 'dmytriykomar@gmail.com',
	phone: '+380939872497',
	group: 'school'
},
{
	full_name: 'Sergiy Hovben',
	email: 'serghov@gmail.com',
	phone: '+380631245447',
	group: 'english'
},
{
	full_name: 'Irina Nebaba',
	email: 'iroshta76@gmail.com',
	phone: '+380671471234',
	group: 'english'
},
]
...
jQuery(function($){
  ...
  function validatePhone(field) {
	...
	// нова форма для нового контакта
	...
	// додавання нового контакту до списку зліва
	...
	// збереження редагованого контакту
...
// фільтер для імені
	...
	// видалення пошукового запиту
	$(document).on('click', '#remove_search_icon', function(){
		$('#search_by_name').val('');
		$('.name_item').fadeIn();
		$(this).fadeOut();
	});
// кінець пошуку за ім'ям
...
// створення нової групи
	...
	// створення нової групи по натисканню enter
...
// кінець створення нової групи

// додавання контакту до певної групи
	$('.transfer').popover({ 
	    html : true,
	    title: function(){
...
// кінець додавання контакту до певної групи
